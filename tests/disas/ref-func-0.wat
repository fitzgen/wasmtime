...
;; @008f                               v16 = load.i32 notrap aligned region0 v15
;; @008f                               v17 = iconst.i32 2
;; @008f                               v18 = band v16, v17  ; v17 = 2
;; @008f                               brif v18, block4, block3
;;
;;                                 block3:
;; @008f                               v20 = load.i64 notrap aligned readonly region1 v0+32
;; @008f                               v21 = load.i32 notrap aligned region0 v20
...
;; @008f                               store notrap aligned region0 v21, v26
...
;; @008f                               store notrap aligned region0 v28, v31
...
;; @008f                               v37 = load.i64 notrap aligned region0 v36
;;                                     v102 = iconst.i64 1
...
;; @008f                               store notrap aligned region0 v38, v43
;; @008f                               store.i32 notrap aligned region0 v8, v20
;; @008f                               jump block4
;;
;;                                 block4:
;;                                     v99 = iconst.i64 96
...
;; @0091                               v54 = load.i32 notrap aligned region0 v53
;; @0091                               v55 = iconst.i32 2
;; @0091                               v56 = band v54, v55  ; v55 = 2
;; @0091                               brif v56, block7, block6
;;
;;                                 block6:
;; @0091                               v58 = load.i64 notrap aligned readonly region1 v0+32
;; @0091                               v59 = load.i32 notrap aligned region0 v58
...
;; @0091                               store notrap aligned region0 v59, v64
...
;; @0091                               store notrap aligned region0 v66, v69
...
;; @0091                               v75 = load.i64 notrap aligned region0 v74
;;                                     v88 = iconst.i64 1
...
;; @0091                               store notrap aligned region0 v76, v81
;; @0091                               store.i32 notrap aligned region0 v46, v58
;; @0091                               jump block7
;;
;;                                 block7:
;; @0093                               v83 = load.i64 notrap aligned region2 v0+112
;; @0095                               v85 = load.i64 notrap aligned region3 v0+128
;; @0097                               jump block1
;;
;;                                 block1:
