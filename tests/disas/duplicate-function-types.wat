...
;;     region5 = 16777232 "VMFuncRef+0x10"
;;     region6 = 16777224 "VMFuncRef+0x8"
;;     region7 = 16777240 "VMFuncRef+0x18"
;;     gv0 = vmctx
...
;; @002d                               v64 = load.i64 notrap aligned readonly can_move region0 v0+48
;; @002d                               v5 = load.i64 notrap aligned region2 v64+8
;; @002d                               v6 = ireduce.i32 v5
;; @002d                               v7 = icmp uge v2, v6
;; @002d                               v8 = uextend.i64 v2
;; @002d                               v62 = load.i64 notrap aligned readonly can_move region0 v0+48
;; @002d                               v9 = load.i64 notrap aligned region1 v62
;;                                     v61 = iconst.i64 3
;; @002d                               v10 = ishl v8, v61  ; v61 = 3
;; @002d                               v11 = iadd v9, v10
;; @002d                               v12 = iconst.i64 0
;; @002d                               v13 = select_spectre_guard v7, v12, v11  ; v12 = 0
;; @002d                               v14 = load.i64 user5 aligned region3 v13
;;                                     v60 = iconst.i64 -2
...
;;
;;                                 block3(v16: i64):
;; @002d                               v22 = load.i64 notrap aligned readonly can_move region4 v0+40
;; @002d                               v23 = load.i32 notrap aligned readonly can_move v22
;; @002d                               v24 = load.i32 user6 aligned readonly region5 v16+16
;; @002d                               v25 = icmp eq v24, v23
;; @002d                               trapz v25, user7
;; @002d                               v26 = load.i64 notrap aligned readonly region6 v16+8
;; @002d                               v27 = load.i64 notrap aligned readonly region7 v16+24
;; @002d                               v28 = call_indirect sig0, v26(v27, v0)
;; @0032                               v58 = load.i64 notrap aligned readonly can_move region0 v0+48
;; @0032                               v30 = load.i64 notrap aligned region2 v58+8
;; @0032                               v31 = ireduce.i32 v30
;; @0032                               v32 = icmp.i32 uge v2, v31
;; @0032                               v33 = uextend.i64 v2
;; @0032                               v56 = load.i64 notrap aligned readonly can_move region0 v0+48
;; @0032                               v34 = load.i64 notrap aligned region1 v56
;;                                     v55 = iconst.i64 3
;; @0032                               v35 = ishl v33, v55  ; v55 = 3
;; @0032                               v36 = iadd v34, v35
;; @0032                               v37 = iconst.i64 0
;; @0032                               v38 = select_spectre_guard v32, v37, v36  ; v37 = 0
;; @0032                               v39 = load.i64 user5 aligned region3 v38
;;                                     v54 = iconst.i64 -2
...
;;
;;                                 block5(v41: i64):
;; @0032                               v47 = load.i64 notrap aligned readonly can_move region4 v0+40
;; @0032                               v48 = load.i32 notrap aligned readonly can_move v47
;; @0032                               v49 = load.i32 user6 aligned readonly region5 v41+16
;; @0032                               v50 = icmp eq v49, v48
;; @0032                               trapz v50, user7
;; @0032                               v51 = load.i64 notrap aligned readonly region6 v41+8
;; @0032                               v52 = load.i64 notrap aligned readonly region7 v41+24
