...
;; @0033                               v8 = load.i64 notrap aligned readonly can_move region0 v0+48
;;                                     v29 = iconst.i64 3
;; @0033                               v9 = ishl v7, v29  ; v29 = 3
;; @0033                               v10 = iadd v8, v9
;; @0033                               v11 = iconst.i64 0
;; @0033                               v12 = select_spectre_guard v6, v11, v10  ; v11 = 0
;; @0033                               v13 = load.i64 user5 aligned region1 v12
;;                                     v28 = iconst.i64 -2
...
;; @0033                               v23 = load.i32 user6 aligned readonly region3 v15+16
;; @0033                               v24 = icmp eq v23, v22
;; @0033                               trapz v24, user7
;; @0033                               v25 = load.i64 notrap aligned readonly region4 v15+8
;; @0033                               v26 = load.i64 notrap aligned readonly region5 v15+24
