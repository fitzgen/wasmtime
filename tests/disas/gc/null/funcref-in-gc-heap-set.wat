...
;; @0022                               v12 = load.i64 notrap aligned readonly can_move region0 v0+8
;; @0022                               v5 = load.i64 notrap aligned readonly can_move region1 v12+32
;; @0022                               v4 = uextend.i64 v2
;; @0022                               v6 = iadd v5, v4
;; @0022                               v7 = iconst.i64 8
;; @0022                               v8 = iadd v6, v7  ; v7 = 8
;; @0022                               store notrap aligned little region3 v11, v8
;; @0026                               jump block1
;;
;;                                 block1:
;; @0026                               return
