...
;; @002a                               v12 = load.i32 notrap aligned region1 v11
;;                                     v53 = iconst.i32 7
...
;; @002a                               v43 = load.i64 notrap aligned readonly can_move region2 v0+8
;; @002a                               v20 = load.i64 notrap aligned region3 v43+40
...
;; @002a                               v25 = load.i64 notrap aligned readonly can_move region4 v43+32
;;                                     v68 = band.i32 v15, v60  ; v60 = -8
;;                                     v69 = uextend.i64 v68
;; @002a                               v27 = iadd v25, v69
;; @002a                               store notrap aligned region1 v61, v27  ; v61 = -1342177256
;; @002a                               v31 = load.i64 notrap aligned readonly can_move region5 v0+40
;; @002a                               v32 = load.i32 notrap aligned readonly can_move v31
;; @002a                               store notrap aligned region1 v32, v27+4
;; @002a                               store.i32 notrap aligned region1 v18, v11
;;                                     v40 = iconst.i64 8
;; @002a                               v33 = iadd v27, v40  ; v40 = 8
;; @002a                               store.f32 notrap aligned little region1 v2, v33
;;                                     v39 = iconst.i64 12
;; @002a                               v34 = iadd v27, v39  ; v39 = 12
;; @002a                               istore8.i32 notrap aligned little region1 v3, v34
;;                                     v36 = load.i32 notrap v45
;;                                     v38 = iconst.i64 16
;; @002a                               v35 = iadd v27, v38  ; v38 = 16
;; @002a                               store notrap aligned little region1 v36, v35
;; @002d                               jump block1
;;
;;                                 block3 cold:
