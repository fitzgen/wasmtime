...
;;                                     store notrap aligned little v4, v38
...
;;                                     v41 = iconst.i64 8
;; @002a                               v33 = iadd v27, v41  ; v41 = 8
;; @002a                               store.f32 notrap aligned little v2, v33
;;                                     v40 = iconst.i64 12
;; @002a                               v34 = iadd v27, v40  ; v40 = 12
;; @002a                               istore8.i32 notrap aligned little v3, v34
;;                                     v37 = load.i32 notrap aligned little v38
;;                                     v39 = iconst.i64 16
;; @002a                               v35 = iadd v27, v39  ; v39 = 16
;; @002a                               store notrap aligned little v37, v35
;; @002d                               jump block1
;;
;;                                 block3 cold:
