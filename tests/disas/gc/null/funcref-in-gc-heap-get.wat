...
;; @0020                               v13 = load.i64 notrap aligned readonly can_move region0 v0+8
;; @0020                               v5 = load.i64 notrap aligned readonly can_move region1 v13+32
;; @0020                               v4 = uextend.i64 v2
;; @0020                               v6 = iadd v5, v4
;; @0020                               v7 = iconst.i64 8
;; @0020                               v8 = iadd v6, v7  ; v7 = 8
;; @0020                               v11 = load.i32 notrap aligned little region3 v8
