...
;;                                     v82 = iconst.i32 7
;; @0025                               v21 = uadd_overflow_trap v18, v82, user17  ; v82 = 7
;;                                     v89 = iconst.i32 -8
;; @0025                               v23 = band v21, v89  ; v89 = -8
;;                                     v74 = iconst.i32 24
;; @0025                               v24 = uadd_overflow_trap v23, v74, user17  ; v74 = 24
;; @0025                               v56 = load.i64 notrap aligned readonly can_move region2 v0+8
;; @0025                               v26 = load.i64 notrap aligned region3 v56+40
...
;; @0025                               v31 = load.i64 notrap aligned readonly can_move region4 v56+32
;;                                     v175 = band.i32 v21, v89  ; v89 = -8
;;                                     v176 = uextend.i64 v175
;; @0025                               v33 = iadd v31, v176
;; @0025                               store notrap aligned region1 v90, v33  ; v90 = -1476394984
...
;; @0025                               store notrap aligned little region1 v49, v103
;;                                     v48 = load.i32 notrap v61
;;                                     v106 = iconst.i64 16
;;                                     v112 = iadd v33, v106  ; v106 = 16
;; @0025                               store notrap aligned little region1 v48, v112
;;                                     v47 = load.i32 notrap v60
;;                                     v129 = iconst.i64 20
;;                                     v135 = iadd v33, v129  ; v129 = 20
;; @0025                               store notrap aligned little region1 v47, v135
;; @0029                               jump block1
;;
;;                                 block3 cold:
