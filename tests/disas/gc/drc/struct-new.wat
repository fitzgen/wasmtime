...
;; @002a                               v54 = load.i64 notrap aligned readonly can_move region0 v0+8
;; @002a                               v12 = load.i64 notrap aligned readonly can_move region1 v54+32
;; @002a                               v13 = uextend.i64 v11
;; @002a                               v14 = iadd v12, v13
;;                                     v53 = iconst.i64 24
;; @002a                               v15 = iadd v14, v53  ; v53 = 24
;; @002a                               store notrap aligned little region2 v2, v15
;;                                     v52 = iconst.i64 28
;; @002a                               v16 = iadd v14, v52  ; v52 = 28
;; @002a                               istore8 notrap aligned little region2 v3, v16
...
;; @002a                               v27 = load.i64 notrap aligned region2 v26
;;                                     v43 = iconst.i64 1
;; @002a                               v28 = iadd v27, v43  ; v43 = 1
;; @002a                               store notrap aligned region2 v28, v26
;; @002a                               jump block3
;;
;;                                 block3:
;;                                     v51 = iconst.i64 32
;; @002a                               v17 = iadd.i64 v14, v51  ; v51 = 32
;; @002a                               store.i32 notrap aligned little region2 v38, v17
;; @002d                               jump block1
;;
;;                                 block1:
;; @002d                               return v11
