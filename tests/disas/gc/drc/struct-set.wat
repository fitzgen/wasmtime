...
;; @0034                               store notrap aligned little region0 v3, v8
;; @0038                               jump block1
;;
;;                                 block1:
;; @0038                               return
...
;; @003f                               istore8 notrap aligned little region0 v3, v8
;; @0043                               jump block1
;;
;;                                 block1:
;; @0043                               return
...
;; @004a                               v9 = load.i32 notrap aligned little region0 v8
;;                                     v58 = iconst.i32 1
...
;; @004a                               v19 = load.i64 notrap aligned region0 v18
;;                                     v69 = iconst.i64 1
;; @004a                               v20 = iadd v19, v69  ; v69 = 1
;; @004a                               store notrap aligned region0 v20, v18
;; @004a                               jump block3
;;
;;                                 block3:
;;                                     v74 = iadd.i64 v6, v7  ; v7 = 32
;; @004a                               store.i32 notrap aligned little region0 v3, v74
;;                                     v75 = iconst.i32 1
...
;; @004a                               v35 = load.i64 notrap aligned region0 v34
;;                                     v80 = iconst.i64 1
...
;; @004a                               store notrap aligned region0 v36, v81
;; @004a                               jump block7
;;
;;                                 block7:
;; @004e                               jump block1
