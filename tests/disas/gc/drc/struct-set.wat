...
;; @0034                               v5 = load.i64 notrap aligned readonly can_move region1 v9+32
;; @0034                               v4 = uextend.i64 v2
;; @0034                               v6 = iadd v5, v4
;; @0034                               v7 = iconst.i64 24
;; @0034                               v8 = iadd v6, v7  ; v7 = 24
;; @0034                               store notrap aligned little region3 v3, v8
;; @0038                               jump block1
;;
;;                                 block1:
;; @0038                               return
...
;; @003f                               v5 = load.i64 notrap aligned readonly can_move region1 v9+32
;; @003f                               v4 = uextend.i64 v2
;; @003f                               v6 = iadd v5, v4
;; @003f                               v7 = iconst.i64 28
;; @003f                               v8 = iadd v6, v7  ; v7 = 28
;; @003f                               istore8 notrap aligned little region3 v3, v8
;; @0043                               jump block1
;;
;;                                 block1:
;; @0043                               return
...
;; @004a                               v59 = load.i64 notrap aligned readonly can_move region0 v0+8
;; @004a                               v5 = load.i64 notrap aligned readonly can_move region1 v59+32
;; @004a                               v4 = uextend.i64 v2
;; @004a                               v6 = iadd v5, v4
;; @004a                               v7 = iconst.i64 32
;; @004a                               v8 = iadd v6, v7  ; v7 = 32
;; @004a                               v9 = load.i32 notrap aligned little region3 v8
;;                                     v58 = iconst.i32 1
...
;; @004a                               v19 = load.i64 notrap aligned region3 v18
;;                                     v69 = iconst.i64 1
;; @004a                               v20 = iadd v19, v69  ; v69 = 1
;; @004a                               store notrap aligned region3 v20, v18
;; @004a                               jump block3
;;
;;                                 block3:
;;                                     v74 = iadd.i64 v6, v7  ; v7 = 32
;; @004a                               store.i32 notrap aligned little region3 v3, v74
;;                                     v75 = iconst.i32 1
...
;; @004a                               v35 = load.i64 notrap aligned region3 v34
;;                                     v80 = iconst.i64 1
...
;; @004a                               store notrap aligned region3 v36, v81
;; @004a                               jump block7
;;
;;                                 block7:
;; @004e                               jump block1
