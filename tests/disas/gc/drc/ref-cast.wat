...
;;                                     store notrap aligned little v2, v33
;;                                     v36 = iconst.i32 0
;; @001e                               v4 = icmp eq v2, v36  ; v36 = 0
;; @001e                               v5 = uextend.i32 v4
;; @001e                               brif v5, block4(v36), block2  ; v36 = 0
;;
;;                                 block2:
...
;; @001e                               v14 = load.i64 notrap aligned readonly can_move v34+32
...
;;                                     v26 = load.i32 notrap aligned little v33
;; @0021                               jump block1
;;
;;                                 block1:
;; @0021                               return v26
