...
;; @0022                               v12 = load.i64 notrap aligned readonly can_move region0 v0+48
;; @0022                               v7 = load.i64 notrap aligned readonly can_move region2 v12
;; @0022                               v8 = iadd v7, v4
;; @0022                               v10 = select_spectre_guard v6, v9, v8  ; v9 = 0
;; @0022                               v11 = load.i32 little region3 v10
;; @0025                               jump block1
;;
;;                                 block1:
;; @0025                               return v11
