...
;; @0040                               v4 = load.i64 notrap aligned region0 v0+64
;; @0040                               v5 = icmp uge v2, v4
;; @0040                               trapnz v5, heap_oob
;; @0040                               v6 = load.i64 notrap aligned can_move region1 v0+56
;; @0040                               v7 = iadd v6, v2
...
;; @0048                               v4 = load.i64 notrap aligned region0 v0+64
;; @0048                               v5 = icmp uge v2, v4
;; @0048                               trapnz v5, heap_oob
;; @0048                               v6 = load.i64 notrap aligned can_move region1 v0+56
;; @0048                               v7 = iadd v6, v2
