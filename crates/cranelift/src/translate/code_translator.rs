...
fn translate_load(
    ...
    let flags_entity = builder.func.dfg.mem_flags.insert(flags);

    let (load, dfg) = builder
        .ins()
        .Load(opcode, result_ty, flags_entity, Offset32::new(0), base);
...
fn translate_store(
    ...
    builder
        .ins()
        .Store(opcode, val_ty, flags_entity, Offset32::new(0), val, base);
    Ok(())
}
