...
/// Drop a `VMExternRef` in place.
pub unsafe extern "C" fn wasmtime_drop_externref_in_place(pointer_to_externref: *mut VMExternRef) {
    ptr::drop_in_place(pointer_to_externref);
}
