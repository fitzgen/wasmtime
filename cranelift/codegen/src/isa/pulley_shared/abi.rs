...
use crate::{
    CodegenResult,
    ir::{self, MemFlagsData, MemFlagsSet, Signature, types::*},
    isa,
    machinst::*,
    settings,
};
    ...
    P: PulleyTargetKind,
{
    ...
    fn gen_load_base_offset(into_reg: Writable<Reg>, base: Reg, offset: i32, ty: Type) -> Self::I {
        ...
        Inst::gen_load(into_reg, mem, ty, MemFlagsSet::TRUSTED).into()
    }

    fn gen_store_base_offset(base: Reg, offset: i32, from_reg: Reg, ty: Type) -> Self::I {
        let base = XReg::try_from(base).unwrap();
        let mem = Amode::RegOffset { base, offset };
        Inst::gen_store(mem, from_reg, ty, MemFlagsSet::TRUSTED).into()
    }
