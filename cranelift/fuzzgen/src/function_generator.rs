...
use cranelift::codegen::ir::{
    AliasRegion, AliasRegionData, AliasRegionSet, AtomicRmwOp, Block, BlockArg, ConstantData,
    Endianness, ExternalName, FuncRef, Function, LibCall, Opcode, SigRef, Signature, StackSlot,
...
fn insert_load_store(
    ...
    // Insert MemFlagsData into DFG to get a MemFlags entity for format constructors.
    let flags = builder.func.dfg.mem_flags.insert(flags_data);
